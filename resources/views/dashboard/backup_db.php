                        ...
                        <div class="card card-raised h-100">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <img src="{{ asset('assets/img/security.svg') }}" alt="..." style="height: 6rem" />
                                </div>
                            </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="me-4">
                                        ...
                                        <div class="progress mb-2" style="height: 0.25rem">
                                            <div class="progress-bar" role="progressbar" style="width: 33%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="30"></div>
                                        </div>
                                        <div class="card-text">10 GB of 30 GB used</div>
                                    </div>
                                    <img src="{{ asset('assets/img/cloud.svg') }}" alt="..." style="height: 6rem" />
                                </div>
                            </div>
